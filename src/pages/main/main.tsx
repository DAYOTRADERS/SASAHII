...
const AppWrapper = observer(() => {
  ...
  const hash = ['dashboard', 'bot_builder', 'chart', 'tutorial', 'copy_trading'];
  ...
  const updateTabShadowsHeight = () => {
    ...
    const leftShadow = document.querySelector('.tabs-shadow--left');
    const rightShadow = document.querySelector('.tabs-shadow--right');
                ...
                <Tabs active_index={active_tab} className="main__tabs" onTabItemClick={handleTabChange} top>
                  ...
                  >
                    <div className="copy-trading-wrapper">
                      <Copy handleTabChange={handleTabChange} />
                    </div>
                  </div>
                  <div
                    label={
